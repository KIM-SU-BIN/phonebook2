...
<body>
	...
	<h2>등록폼</h2>
	<p>
		정보를 수정하려면 <br> 아래 항목을 변경하고 "수정" 버튼을 클릭하세요.
	</p>
	...
	<form action="/phonebook3/modify" method="get">
		...
		등록번호(personId)<input type="text" name="personId" value="${personVo.personId}"> <br> 이름(name) 
		<input type="text" name="name" value="${personVo.name}"> <br>핸드폰(hp) 
		<input type="text" name="hp" value="${personVo.hp}"> <br> 회사번호(company) 
